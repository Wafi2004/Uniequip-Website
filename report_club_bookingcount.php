...
$sql = "
    SELECT club_name, COUNT(*) AS total_bookings
    FROM booking
...
<head>
    ...
    <title>Club Booking Statistics - UniEquip</title>
        ...
        <div class="main-content">
            ...
            <div class="top-header">
                <div class="header-left">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-separator">/</span>
                        <span class="breadcrumb-item active">Club Booking Statistics Report</span>
                    </div>
                </div>
            ...
            <div class="content-area">
                ...
                <div class="print-header">
                    <h1>UniEquip - Club Booking Statistics Report</h1>
                ...
                <div class="table-container">
                    <div class="table-header">
                        <h2 class="table-title">
                            <i class="fas fa-users" style="margin-right: 8px; color: var(--accent-color);"></i>
                            Total Bookings by Club
                        </h2>
                        <div class="table-meta">
                            <i class="fas fa-database"></i>
                            <?php echo $result->num_rows; ?> club<?php echo $result->num_rows !== 1 ? 's' : ''; ?> found
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div style="text-align: center;">
                                                    <div style="width: 60px; height: 6px; background-color: var(--border-light); border-radius: 3px; overflow: hidden; margin: 0 auto 4px;">
                                                        <div style="width: <?php echo $percentage; ?>%; height: 100%; background: linear-gradient(90deg, var(--accent-color), var(--primary-color)); border-radius: 3px;"></div>
                                                    </div>
