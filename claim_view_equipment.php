...
// Fetch booking details with equipment
...
<head>
    ...
    <title>Booking #<?= htmlspecialchars($id_booking) ?> Equipment - UniEquip</title>
        ...
        <div class="main-content">
            ...
            <div class="top-header">
                <div class="header-left">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-separator">/</span>
                        <a href="claim_equipment.php" class="breadcrumb-item">Claim Equipment</a>
                        <span class="breadcrumb-separator">/</span>
            ...
            <div class="content-area">
                <?php if ($booking_info): ?>
                    ...
                    <div class="booking-info-card">
                        <div class="booking-info-header">
                            ...
                            <div>
                                <h2 style="margin: 0; font-size: 20px;">Booking #<?= htmlspecialchars($id_booking) ?></h2>
                                <p style="margin: 0; opacity: 0.9; font-size: 14px;">Equipment details for claim verification</p>
                            </div>
                        </div>
                        <div class="booking-info-grid">
                            ...
                            <div class="booking-info-item">
                                <div class="booking-info-label">Booked By</div>
                ...
                <div class="table-container">
                    <div class="table-header">
                        ...
                        <div class="table-meta">
                            ...
                            <?php echo $result->num_rows; ?> item<?php echo $result->num_rows !== 1 ? 's' : ''; ?> in this booking
                        </div>
                    </div>
                            ...
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <div class="equipment-card">
                                    ...
                                    <div class="image-section">
                                        <?php 
                                        // Remove any existing 'uploads/' from the path to prevent duplication
                                        ...
                                        <?php else: ?>
                                            <div class="no-image">
                                                ...
                                                if (!empty($row['picture'])) {
                                                    echo "Image missing: " . htmlspecialchars($imagePath);
                                                } else {
                                                    echo "No image available for this equipment";
                                                }
                                                ?>
                                            </div>
                                        <?php endif; ?>
                ...
                <div style="display: flex; gap: 12px; margin-top: 24px;">
                    <a href="claim_equipment.php" class="btn btn-secondary">
